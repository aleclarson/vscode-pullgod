...
- `Pullgod: View Pull Requests` automatically suspends background polling after 5 minutes of inactivity to save resources.
...
- Only activate the pull interval when a PR branch is checked out.
